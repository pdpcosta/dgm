...
O objetivo geral do projeto final desta disciplina é dar a oportunidade de implementação de um modelo generativo baseado em deep learning.
...
> 
> Link para vídeo de apresentação da proposta do projeto (máximo 5 minutos).

# Bases de Dados
> Elencar bases de dados candidatas a serem utilizadas no projeto.

# Metodologia
> Para a primeira entrega, descreva de maneira mais genérica quais abordagens seu grupo estudará.
